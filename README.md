...
A modern, feature-rich web-based dashboard for managing Laragon development environment. Version 3.1.7 aims to be a comprehensive MAMP competitor on Windows, replicating Laragon control panel functionality in a modern, themed web interface.

[![Version](https://img.shields.io/badge/version-3.1.7-blue.svg)](https://github.com/LebToki/Laragon-Dashboard)
