 ...
 * Description: Clean servers page following template structure
 * Version: 2.6.1
 */

// Load services helpers
require_once __DIR__ . '/services-helpers.php';

// Include layout top (following blank-page.php structure)
include PARTIALS_ROOT . '/layouts/layoutTop.php';
?>
                ...
                <div class="card-body p-16">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-8">
                        <div>
                            ...
                            <h6 class="mb-0"><a href="http://localhost/phpmyadmin" target="_blank">Manage MySQL</a></h6>
                        </div>
                        <div class="w-50-px h-50-px bg-info-main rounded-circle d-flex justify-content-center align-items-center">
...
<?php
// Include layout bottom (following blank-page.php structure)
include PARTIALS_ROOT . '/layouts/layoutBottom.php';
?>
