...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="LaragonDash/assets/favicon.ico">
    <title><?php echo $translations['title'] ?? 'Welcome to the Laragon Dashboard'; ?></title>

    <link href="https://fonts.googleapis.com/css?family=Pt+Sans&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,700&display=swap">
    <link rel="stylesheet" href="LaragonDash/assets/style.css">
    ...
    <link rel="icon" href="LaragonDash/assets/favicon/favicon.ico" type="image/x-icon">
    <link rel="icon" type="image/png" href="LaragonDash/assets/favicon/favicon-16x16.png" sizes="16x16">
    <link rel="icon" type="image/png" href="LaragonDash/assets/favicon/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="LaragonDash/assets/favicon/android-chrome-192x192.png" sizes="192x192">
    <link rel="icon" type="image/png" href="LaragonDash/assets/favicon/android-chrome-512x512.png" sizes="512x512">
    <link rel="icon" type="apple-touch-icon" href="LaragonDash/assets/favicon/apple-touch-icon.png">
    <link rel="manifest" href="LaragonDash/assets/favicon/site.webmanifest">
    ...
    $(document).ready(function() {
        ...
        $('#project-search').on('input', function() {
            var q = $(this).val();
            $.get('LaragonDash/project_search.php', {q: q}, function(data) {
    ...
    function fetchServerVitals() {
        $.ajax({
            url: 'LaragonDash/server_vitals.php',
            method: 'GET',
            dataType: 'json',
...
?>
    ...
    function loadDatabases() {
        $.get('LaragonDash/database_manager.php?action=list_databases', function(data) {
            if (data.success) {
    ...
    function loadTables(database) {
        $.get('LaragonDash/database_manager.php?action=get_tables&database=' + encodeURIComponent(database), function(data) {
            if (data.success) {
    ...
    function getDatabaseSize(database) {
        $.get('LaragonDash/database_manager.php?action=get_database_size&database=' + encodeURIComponent(database), function(data) {
            if (data.success) {
    ...
    function executeQuery() {
        ...
        $.post('LaragonDash/database_manager.php?action=execute_query', {query: query}, function(data) {
            if (data.success) {
    ...
    function loadServices() {
        $.get('LaragonDash/services_manager.php?action=status', function(data) {
            if (data.success) {
    ...
    function controlService(service, action) {
        ...
        $.get('LaragonDash/services_manager.php?action=' + action + '&service=' + encodeURIComponent(service), function(data) {
            if (data.success) {
    ...
    function refreshPorts() {
        $.get('LaragonDash/services_manager.php?action=get_ports', function(data) {
            if (data.success) {
    ...
    function loadLogs() {
        $.get('LaragonDash/log_viewer.php?action=list_logs', function(data) {
            if (data.success) {
    ...
    function loadLog() {
        ...
        $.get('LaragonDash/log_viewer.php?action=read_log&path=' + encodeURIComponent(logPath) + '&lines=' + lines, function(data) {
            if (data.success) {
    ...
    function clearLog() {
        ...
        $.get('LaragonDash/log_viewer.php?action=clear_log&path=' + encodeURIComponent(logPath), function(data) {
            if (data.success) {
    ...
    function clearCache() {
        $.post('LaragonDash/quick_tools.php', {action: 'clear_cache'}, function(data) {
            if (data.success) {
    ...
    function optimizeDatabase() {
        ...
        $.post('LaragonDash/quick_tools.php', {action: 'optimize_database', database: database}, function(data) {
            if (data.success) {
    ...
    function gitStatus() {
        ...
        $.post('LaragonDash/quick_tools.php', {action: 'git_status', project_path: projectPath}, function(data) {
            if (data.success) {
    ...
    function composerInstall() {
        ...
        $.post('LaragonDash/quick_tools.php', {action: 'composer_command', project_path: projectPath, command: 'install'}, function(data) {
    ...
    function npmInstall() {
        ...
        $.post('LaragonDash/quick_tools.php', {action: 'npm_command', project_path: projectPath, command: 'install'}, function(data) {
            $('#tools-output').html('<div class="alert alert-info"><strong>NPM Output:</strong><pre>' + (data.output || '') + '</pre></div>');
        });
    }

    function showPhpInfo() {
        $.get('LaragonDash/quick_tools.php?action=php_info', function(data) {
            if (data.success) {
    ...
    function viewTableStructure(database, table) {
        $.get('LaragonDash/database_manager.php?action=get_table_structure&database=' + encodeURIComponent(database) + '&table=' + encodeURIComponent(table), function(data) {
            if (data.success) {
