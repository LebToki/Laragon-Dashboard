...
<div class="dashboard-main-body">
    <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0"><?php echo $translations['services_tab'] ?? 'Services'; ?></h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium"><?php echo $translations['services_tab'] ?? 'Services'; ?></li>
            </ul>
        </div>

        <div class="card">
            <div class="card-body p-24">
                <p class="text-secondary-light">Services page - Coming soon</p>
            </div>
        </div>
    </div>
</div>
